...
object RepeatPatternReducer : BaseViewStateReducer<RepeatPatternViewState>() {
            ...
            RepeatType.MONTHLY -> {
                if (state.isFlexible) {
                    RepeatPattern.Flexible.Monthly(
                        ...
                        startDate = state.startDate,
                        endDate = state.endDate,
                        skipEveryXPeriods = state.skipEveryXPeriods
                    )
                } else {
    ...
    override fun defaultState() =
        RepeatPatternViewState(
            ...
            everyXDaysValues = (0..20).toList(),
            everyXWeeksValues = (0..10).toList(),
            everyXMonthsValues = (0..5).toList(),
            isFlexible = true,
